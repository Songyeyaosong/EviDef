...
def edl_loss_v5(pred,
    ...
    loss_ce = (-target_onehot * (torch.log(alpha / s + 1e-5))).sum(dim=1)
...
class EDLLossV5(nn.Module):
    ...
    def forward(self,
        ...
        loss_cls = self.loss_weight * edl_loss_v5(
            pred,
            e_sum,
            target_onehot,
            weight,
