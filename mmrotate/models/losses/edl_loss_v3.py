...
def loss_euc(s, p, target_onehot, lambdat):
    ...
    l_euc = -lambdat * l_euc1 - (2 - lambdat) * l_euc2

    return l_euc.squeeze(-1)
    
def edl_loss_v3(pred,
                e_sum,
                target_onehot,
                weight=None,
                lambdat=1.0,
    ...
    l_euc = loss_euc(s, p_detach, target_onehot, lambdat)
...
class EDLLossV3(nn.Module):
    ...
    def forward(self,
        ...
        loss_cls = self.loss_weight * edl_loss_v3(
            pred,
            e_sum,
            target_onehot,
            weight,
