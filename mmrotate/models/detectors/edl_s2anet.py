...
class EDLS2ANet(RotatedBaseDetector):
    ...
    def forward_train(self,
        ...
        outs = self.fam_head(x)  # cls_score, bbox_pred
        ...
        rois = self.fam_head.refine_bboxes(*outs)  # rois里面的角度是弧度: pi转换成的数值
        # rois: list(indexed by images) of list(indexed by levels)
    ...
    def beta_cls_score_to_logit(self, beta_cls_score):
        ...
        for score in beta_cls_score:
            ...
            ab = (torch.exp(score) + 1).permute(0,2,3,1)
