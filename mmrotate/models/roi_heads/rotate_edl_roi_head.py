...
from mmrotate.core import build_assigner, build_sampler, obb2xyxy, edl_rbbox2result, rbbox2result
from ..builder import (ROTATED_HEADS, build_head, build_roi_extractor,
                       build_shared_head)


@ROTATED_HEADS.register_module()
class RotatedEdlRoIHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        super(RotatedEdlRoIHead, self).__init__(init_cfg)
