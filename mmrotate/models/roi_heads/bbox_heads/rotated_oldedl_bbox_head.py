...
from mmrotate.core import build_bbox_coder, edl_multiclass_nms_rotated
from ...builder import ROTATED_HEADS, build_loss


@ROTATED_HEADS.register_module()
class RotatedOldEdlBBoxHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(RotatedOldEdlBBoxHead, self).__init__(init_cfg)
