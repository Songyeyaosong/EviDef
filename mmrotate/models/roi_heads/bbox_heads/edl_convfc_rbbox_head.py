...
class RotatedEdlConvFCBBoxHead(RotatedEdlBBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(RotatedEdlConvFCBBoxHead, self).__init__(
...
@ROTATED_HEADS.register_module()
class RotatedEdlShared2FCBBoxHead(RotatedEdlConvFCBBoxHead):
    """Shared2FC RBBox head."""

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(RotatedEdlShared2FCBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@ROTATED_HEADS.register_module()
class RotatedEdlKFIoUShared2FCBBoxHead(RotatedEdlConvFCBBoxHead):
    """KFIoU RoI head."""

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(RotatedEdlKFIoUShared2FCBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
