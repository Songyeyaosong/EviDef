...
class RotatedOldEdlConvFCBBoxHead(RotatedOldEdlBBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(RotatedOldEdlConvFCBBoxHead, self).__init__(
...
@ROTATED_HEADS.register_module()
class RotatedOldEdlShared2FCBBoxHead(RotatedOldEdlConvFCBBoxHead):
    """Shared2FC RBBox head."""

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(RotatedOldEdlShared2FCBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@ROTATED_HEADS.register_module()
class RotatedOldEdlKFIoUShared2FCBBoxHead(RotatedOldEdlConvFCBBoxHead):
    """KFIoU RoI head."""

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(RotatedOldEdlKFIoUShared2FCBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
