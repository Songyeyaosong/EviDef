...
from mmrotate.core import build_bbox_coder, multiclass_nms_rotated, edl_multiclass_nms_rotated, edl_open_multiclass_nms_rotated
from ...builder import ROTATED_HEADS, build_loss


@ROTATED_HEADS.register_module()
class RotatedEdlBBoxHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(RotatedEdlBBoxHead, self).__init__(init_cfg)
    ...
    def get_bboxes(self,
        ...
        if cfg is None:
            ...
            # det_bboxes, det_labels = edl_open_multiclass_nms_rotated(
            #     bboxes, scores, u, cfg.score_thr, cfg.nms, cfg.max_per_img)
