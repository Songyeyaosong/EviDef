...
class RotatedTedfBBoxHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(RotatedTedfBBoxHead, self).__init__(init_cfg)
        ...
        # self.loss_tedf = build_loss(dict(type='TedfLoss',
        #                                  lambdat=1.0, 
        #                                  l1_regular_weight=0.1,
        #                                  loss_weight=0.25))
        # self.loss_tedf = build_loss(dict(type='CeTedfLoss',
        #                                  use_sigmoid=False,
        #                                  l1_regular_weight=0.1,
        #                                  loss_weight=1.0))
    ...
    @force_fp32(apply_to=('cls_pred', 'bbox_pred', 'w'))
    def _loss_tedf(self,
                   cls_pred,
                   labels,
                   label_weights,
        ...
        if cls_pred is not None:
            ...
            if cls_pred.numel() > 0:
                ...
                if isinstance(loss_cls_, dict):
                    ...
                    losses['loss_tedf'] = loss_cls_
                if self.custom_activation:
                    acc_ = self.loss_cls.get_accuracy(cls_pred, labels)
                    losses.update(acc_)
                else:
                    losses['acc_tedf'] = accuracy(cls_pred, labels)
        return losses
        ...
        if cls_score is not None:
            ...
            if cls_score.numel() > 0:
                ...
                if self.custom_activation:
                    ...
                    losses['fine_acc'] = accuracy(cls_score, labels)
        return losses
