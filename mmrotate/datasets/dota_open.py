...
from mmrotate.core import edl_eval_rbbox_map, eval_rbbox_map, obb2poly_np, poly2obb_np
from .builder import ROTATED_DATASETS


@ROTATED_DATASETS.register_module()
class DOTAOpenDataset(CustomDataset):
    ...
    """
    CLASSES = ('baseball-diamond', 'bridge', 'ground-track-field',
               'large-vehicle', 'ship',
               'basketball-court', 'storage-tank', 'soccer-ball-field',
               'roundabout', 'harbor', 'swimming-pool', 'helicopter', 'unknown')
    ...
    def __init__(self,
        ...
        super(DOTAOpenDataset, self).__init__(ann_file, pipeline, **kwargs)
